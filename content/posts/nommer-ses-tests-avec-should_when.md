...
Cela permet de comprendre comment le code *devrait* se comporter. Si le test échoue, on est alors capable d'identifier instantanément le comportement en erreur.
...
```
On remarque que les trois points clés sont bien respectés :
